---
title: "Time Series Analysis of Confirmed Malaria Cases Using ARIMA, SARIMA and ARIMAX Models"
...
# **Definition of the Monthly Time Series Object**
...
```{r decomposition-multiplicative}
# Multiplicative decomposition
...
### **Interpretation of the Multiplicative Decomposition**
...
(p,d,q), each representing a specific component of the series dynamics.
...
In an AR(p) model, the observation at time 
t is expressed as a linear combination of the previous p observations.
...
## **Non-Seasonal ARIMA Model (Baseline)**
...
### **Interpretation of the Non-Seasonal ARIMA Model**
...
## **Diagnostic Analysis of the Non-Seasonal ARIMA Model**
...
## **Automatic Identification - SARIMA Model**
```{r}
#SARIMA
...
### **Interpretation of the Selected SARIMA Model**
...
## **Residual Diagnostics of the SARIMA Model**
...
# **ARIMAX Modelling (ARIMA with Exogenous Variables)**
...
### **Interpretation of the ARIMAX Model**
...
## **Residual Diagnostics of the ARIMAX Model**
```{r}
#ARIMAX Diagnostics
checkresiduals(model_arimax)
```

### **Interpretation of ARIMAX Diagnostics**
...
# **Model Comparison: ARIMA vs SARIMA vs ARIMAX**
...
# **Forecasting Confirmed Malaria Cases (SARIMA Model)**
